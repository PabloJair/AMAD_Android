...
object  ClientRetrofit {
    ...
    private fun getInstanceNoUnsafe():Retrofit {
    ...
    private fun getSSLConfig(context: Context): SSLContext? {
        ...
        var ca: Certificate?
        val cert   =context.resources.openRawResource(com.s10plus.core_application.R.raw.cert)
    ...
    fun <T> getClientNoUnsafe(service: Class<T>): T {
        return getInstanceNoUnsafe().create(service)
    }
